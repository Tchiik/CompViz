...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 4 + 1  # Car Background + scratch
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("scratch", 2, "door_scratch")
        self.add_class("scratch", 3, "bumper_dent")
        self.add_class("scratch", 4, "door dent")
            ...
            for n in objects:
                ...
                try:
                    if n.key()=='scratch':
                            ...
                            class_ids.append(3)
                    elif n.key()=='door dent':
                            class_ids.append(4)
                except:
                    pass
                
            #class_ids = [int(n['object_name']) for n in objects]
